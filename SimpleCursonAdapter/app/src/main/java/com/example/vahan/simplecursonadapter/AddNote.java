...
public class AddNote extends BaseActivity implements  View.OnClickListener {
    ...
    private DB db;
    private ToggleButton tg, alarm;
    private int image, alarmImage;
    private int cnt = 0;
    View view;
    private final int DIALOG1 = 2;
        ...
        switch (item.getItemId()) {
            case R.id.button:
                if (e.getText().toString().equals("") && e1.getText().toString().equals("") || (e.getText().toString().equals(""))) {
                    ...
                    String date = getString(R.string.Created) + String.valueOf(DateFormat.format("dd.MM.yyyy,hh:mm ", new Date()));
    ...
    protected void onPrepareDialog(final int id, final Dialog dialog) {
        ...
        RelativeLayout relativeLayout = (RelativeLayout) dialog.findViewById(R.id.dgdg);
        ToggleButton toggleButton = (ToggleButton) dialog.findViewById(R.id.toggleButton0);
        pass = (EditText) dialog.findViewById(
                R.id.editPassword);
        EditText old = (EditText) dialog.findViewById(R.id.editText5);
        if (id == DIALOG1) {
            ...
            Button but = (Button) dialog.findViewById(R.id.button6);
